...
const ContactMobile = ({ contact2Ref }) => {
  //form state
              ...
              <VStack spacing="0px">
                ...
                >
                  ...
                  >
                    ...
                    Do you need a professional Developer? <br />
                    Let's talk.
                  </Text>
                ...
                <section id="#FormReturn">
                  ...
                  >
                    <Box textAlign="center">
                      <Icon as={AiOutlineMail} boxSize="60px" mb="10px" />
            ...
            <VStack spacing="0px">
              ...
              <section id="#form">
                <form onSubmit={handleSubmit}>
                  <VStack align="left" spacing="15px" py="80px">
                    <Heading
                      fontFamily="Oswald"
                      fontSize="50px"
                      color="orange.400"
